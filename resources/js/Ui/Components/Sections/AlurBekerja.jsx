...
import { AlurKamiBekerja } from "../../../Const/Home";
                ...
                <div className="w-full mt-10 md:mt-14 justify-between hidden md:flex">
                    {AlurKamiBekerja.map((data, index) => (
                        ...
                        >
                            ...
                            >
                                {index === AlurKamiBekerja.length - 1
                                    ? "Final Step"
                                    : `Step ${index + 1}`}
                            </span>
                            <h1
